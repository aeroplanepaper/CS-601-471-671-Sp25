...
def cpu_gpu_comparison(train_dataset, dev_dataset, max_iter=100):
    ...
    run(train_dataset, dev_dataset, max_iter=max_iter, device='cuda:0', plot=False, sample=False)


def gpu_full_run(train_dataset, dev_dataset, max_iter=20000):
    run(train_dataset, dev_dataset, max_iter=max_iter, device='cuda:0', plot=True, sample=True)
